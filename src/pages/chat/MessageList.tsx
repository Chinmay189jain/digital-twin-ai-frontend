      ...
      {messages.length === 0 && (
        <div className="text-center py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-2xl mx-auto">
            ...
            >
              <span className="text-sm text-gray-900 dark:text-white">{CHATS.QUESTION_1}</span>
            </button>
            ...
            <button
              ...
              className="p-3 text-left border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200"
            >
              <span className="text-sm text-gray-900 dark:text-white">{CHATS.QUESTION_2}</span>
            </button>
            ...
            <button
              ...
              className="p-3 text-left border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200"
            >
              <span className="text-sm text-gray-900 dark:text-white">{CHATS.QUESTION_3}</span>
            </button>

            <button
              onClick={() => onSuggest(CHATS.QUESTION_4)} // ✅ FIXED
              className="p-3 text-left border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200"
            >
              <span className="text-sm text-gray-900 dark:text-white">{CHATS.QUESTION_4}</span>
            </button>
          </div>
        </div>
      )}
            ...
            {msg.aiResponse !== undefined &&
              (msg.aiResponse.trim() !== '' || (isLast && isStreaming)) && (
                <ChatBubble
                  ...
                  onDone={isLast && isStreaming ? onStreamDone : undefined} 
                />
              )}
          </React.Fragment>
        );
